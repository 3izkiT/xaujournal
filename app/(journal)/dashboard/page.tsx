            ...
            <table className="min-w-full text-left text-sm">
              <thead className="border-b border-slate-200 text-xs uppercase tracking-wide text-slate-400">
                <tr>
                  ...
                  <th className="px-2 py-3">Emotion</th>
                </tr>
              </thead>
              <tbody>
                {recentTrades.map((trade) => (
                  <tr key={trade.id} className="border-b border-slate-100 text-slate-700">
                    ...
                    <td className="px-2 py-3">{trade.session.replace(" Session", "")}</td>
                    <td className="px-2 py-3">{trade.rMultiple}</td>
                    ...
                    <td className="px-2 py-3">{trade.emotion}</td>
                  </tr>
                ))}
              </tbody>
            </table>
