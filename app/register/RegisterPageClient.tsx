    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-xau-app px-4 py-10">
        <div className="xau-card-bordered w-full max-w-md p-8">
          ...
          <h1 className="mt-4 text-2xl font-semibold text-xau-ink">Join {BRAND_NAME}</h1>
          <p className="mt-2 text-sm text-xau-muted">
            Early access: full journal features free. Sign up with Google in one step.
          </p>
          <GoogleOnlyAuthPanel variant="register" />
